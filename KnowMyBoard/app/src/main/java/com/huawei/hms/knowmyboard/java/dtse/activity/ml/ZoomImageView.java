...
public class ZoomImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.delayedZoomVariables != null) {
            this.setZoom(
                    this.delayedZoomVariables.scale,
                    this.delayedZoomVariables.focusX,
                    this.delayedZoomVariables.focusY,
                    this.delayedZoomVariables.scaleType);
    ...
    private void fitImageToView() {
        ...
        if (!this.isZoomed() && !this.imageRenderedAtLeastOnce) {
            ...
            this.translateMatrixAfterRotate(
                    Matrix.MTRANS_X,
                    transX,
                    prevActualWidth,
                    actualWidth,
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            if (ZoomImageView.this.state == State.NONE) {
                float targetZoom =
                        (Math.abs(ZoomImageView.this.normalizedScale - ZoomImageView.this.minScale) < 0.00001f)
                                ? ZoomImageView.this.maxScale
                                : ZoomImageView.this.minScale;
    ...
    private class PrivateOnTouchListener implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (ZoomImageView.this.state == State.NONE
                    || ZoomImageView.this.state == State.DRAG
                    || ZoomImageView.this.state == State.FLING) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        if (ZoomImageView.this.state == State.DRAG) {
                            ...
                            float fixTransX =
                                    ZoomImageView.this.getFixDragTrans(
                                            deltaX, ZoomImageView.this.viewWidth, ZoomImageView.this.getImageWidth());
                            float fixTransY =
                                    ZoomImageView.this.getFixDragTrans(
                                            deltaY, ZoomImageView.this.viewHeight, ZoomImageView.this.getImageHeight());
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
            ...
            if (animateToZoomBoundary) {
                DoubleTapZoom doubleTap =
                        new DoubleTapZoom(
                                targetZoom,
                                (ZoomImageView.this.viewWidth / 2.0f),
                                (ZoomImageView.this.viewHeight / 2.0f),
                                true);
                ZoomImageView.this.compatPostOnAnimation(doubleTap);
            }
        }
