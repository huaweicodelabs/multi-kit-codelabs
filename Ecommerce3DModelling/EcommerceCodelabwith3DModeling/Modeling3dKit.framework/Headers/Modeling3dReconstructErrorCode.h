...
typedef NS_ENUM(NSUInteger, MRErrorCode) {
    ...
    /** 压缩失败 */
    ERR_COMPRESS_FAIL                       = 1130,
    /** 分片失败 */
    ERR_FILE_SPLIT_FAIL                     = 1131,
    /** 重建未完成不支持下载 */
    ERR_DOWNLOAD_NOT_SUPPORT                = 1132,
    /** 配额用尽 */
    ERR_RET_BILLING_QUOTA_EXHAUSTED         = 1133,
    /** 欠费 */
    ERR_RET_BILLING_OVERDUE                 = 1134,
    /** 项目未订购 */
    RET_ORDER_NOT_EXIST                     = 1135,
