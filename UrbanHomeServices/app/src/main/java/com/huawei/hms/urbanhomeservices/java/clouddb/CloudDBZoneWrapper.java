...
public class CloudDBZoneWrapper<T extends CloudDBZoneObject> {
     ...
     *
     * @param snapshot cloud db snap shot
     */
     ...
     *
     * @param <T> class of callback method.
     */
    ...
    public void queryAllData(CloudDBZoneQuery<T> query) {
        ...
        queryTask.addOnSuccessListener(this::processQueryResult).addOnFailureListener(e -> mUiCallBack.updateUiOnError("Query failed"));
    }
