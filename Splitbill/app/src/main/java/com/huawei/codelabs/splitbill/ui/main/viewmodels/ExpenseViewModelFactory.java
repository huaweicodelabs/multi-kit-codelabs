...
public class ExpenseViewModelFactory implements ViewModelProvider.Factory {
    public static final String TAG = "ExpenseViewModelFactory";
    private final Activity mApplication;

    public ExpenseViewModelFactory(Activity application) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new ExpenseViewModel(mApplication.getApplication());
    }
}
