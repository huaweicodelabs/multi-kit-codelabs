...
public class FriendsViewModelFactory implements ViewModelProvider.Factory {
    public static final String TAG = "FriendsViewModelFactory";
    private final Activity mApplication;
    public String reminderType;

    public FriendsViewModelFactory(Activity application) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new FriendsViewModel(mApplication.getApplication());
    }
}
