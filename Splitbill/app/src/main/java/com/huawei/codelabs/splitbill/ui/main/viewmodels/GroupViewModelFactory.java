...
public class GroupViewModelFactory implements ViewModelProvider.Factory {
    public static final String TAG = "GroupViewModelFactory";
    private final Activity mApplication;

    public GroupViewModelFactory(Activity application) {
        mApplication = application;
    }

    @Override
    public <T extends ViewModel> T create(Class<T> modelClass) {
        return (T) new GroupViewModel(mApplication.getApplication());
