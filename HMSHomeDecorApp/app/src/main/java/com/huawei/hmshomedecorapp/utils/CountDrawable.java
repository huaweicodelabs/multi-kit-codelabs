...
import com.huawei.hmshomedecorapp.R;
    ...
    public class CountDrawable extends Drawable {
        ...
        public CountDrawable(Context context) {
            ...
            mBadgePaint.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.white));
        ...
        public void draw(Canvas canvas) {
            ...
            if(mCount.length() < 2){
                ...
                if((!mCount.equalsIgnoreCase("")) && (!mCount.equalsIgnoreCase("0"))){
                    canvas.drawCircle(centerX, centerY, (int)(radius+6.5), mBadgePaint);
                }

            }
            else{
                canvas.drawCircle(centerX, centerY, (int)(radius+10.5), mBadgePaint);
            }
