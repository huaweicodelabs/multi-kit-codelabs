...
public class CustomSceneView extends SceneView {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        loadScene("SceneView/scene_prince.gltf"); // Loads the model of a scene by reading files from assets.
        loadSpecularEnvTexture("SceneView/specularEnvTexture.dds");
        loadDiffuseEnvTexture("SceneView/diffuseEnvTexture.dds"); // Loads diffuse maps by reading files from assets.
    }
