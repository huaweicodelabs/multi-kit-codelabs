...
package com.huawei.hmshomedecorapp.activity.ui.electronics;
...
public class ElectronicsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        itemModels.add(new ItemModel(R.drawable.led_tv,"Smart TV"));
        itemModels.add(new ItemModel(R.drawable.washing_machine, "Washing Machine"));
        itemModels.add(new ItemModel(R.drawable.decorate_light,"Ceiling Light"));
        itemModels.add(new ItemModel(R.drawable.cooler,"Cooler"));
